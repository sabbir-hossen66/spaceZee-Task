      ...
      <section class="bg-white ">
        <div class="container px-6 py-12 mx-auto">
          <div class="text-center ">
            ...
            <p class="mt-3 text-gray-600 ">Chat to our friendly team.</p>
          </div>
          ...
          <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            <div class="p-4 rounded-lg bg-blue-50 md:p-6 ">
              <span class="inline-block p-3 text-orange-500 rounded-lg bg-blue-100/80 ">
              ...
              <p class="mt-2 text-sm text-orange-500 ">hello@merakiui.com</p>
            </div>
            ...
            <div class="p-4 rounded-lg bg-blue-50 md:p-6 ">
              ...
              <p class="mt-2 text-sm text-orange-500 ">100 Smith Street Collingwood VIC 3066 AU</p>
            </div>
            ...
            <div class="p-4 rounded-lg bg-blue-50 md:p-6 ">
              ...
              <p class="mt-2 text-sm text-orange-500 ">+1 (555) 000-0000</p>
            </div>
          </div>
        </div>
      </section>
